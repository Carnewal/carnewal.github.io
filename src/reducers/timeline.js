const initialState = {
    ...
    pastItems: [
        ...
        },
        {
            ...
            description: 'The year I graduated Applied Informatics I had the opportunity to do an internship. **PieSync** took me on their team and I learned a LOT about **React, Ruby on Rails** and all the frameworks you can imagine.  \n\nI also delivered a **thesis** on using the Smartphone as a controller for Local Multiplayer games which was a subject I had been interested in for a while.'
        },
        {
            year: '2015',
            icon: 'line-chart',
            title: 'Improving my skills.', 
            description: 'This schoolyear I learned all about **Android, iOS and Angular (1)**, which were the types of courses I\'d been hoping to get ever since I was a kiddo. \n\nAttending lectures about **React** and hackathons like **Hack the future** with friends boosted my interest in web development and coding in general even more. I also got to work at ON again.'
        },
        {
            year: '2014',
            icon: 'car',
            title: 'Im learnding!', 
            description: 'I also learned how to drive!'
        },
        {
            year: '2013',
            title: 'My first year', 
